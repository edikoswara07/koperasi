...
<head>
    ...
    <title>{{ config('app.name', 'Koperasi Bandung Wins') }} </title>
    ...
    <section class="container mx-auto px-4 mt-28">
        <div class="flex items-center justify-between space-x-12">
            <div class="w-4/12">
                ...
                <div class="flex mt-6">
                    <a href="#" class="px-6 py-2 bg-teal-900 text-white font-normal text-sm rounded-md shadow-md">Let's Join Us</a>
                </div>
            </div>
